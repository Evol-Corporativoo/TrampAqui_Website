...
>
  <head>
    ...
    <title>Painel | Vagas Cadastradas</title>
    ...
    <script defer src="./js/buscadorVagas.js"></script>
    <link rel="stylesheet" href="../css/dash-table.css">
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <div class="content-wrapper">
                  ...
                  <!-- <h1>Minha Empresa</h1> -->
                  <div>
                    <h1 style="text-align: center; margin-top: 3%;"><?php echo($empresaAtual['nomeEmpresa']); ?></h1>
                    <table id="vagas" class="table_vagas">
                      <thead>
                        <th class="tiny">#</th>
                        <th class="medium">Nome da Vaga</th>
                        <th class="medium">Cargo</th>
                        <th class="large">Descrição</th>
                        <th class="medium">Carga horária</th>
                        <th class="small">Candidatos</th>
                        <th class="small">Editar</th>
                        <th class="small">Fechar</th>
                      </thead>
                      <tbody id="vagas-buscadas">
