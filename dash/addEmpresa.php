...
>
  <head>
    ...
    <title>Painel | Criar empresa</title>
    ...
    <script defer src="../js-formatacao/viacep.js"></script>
    <script defer src="../js-formatacao/verificaComplemento.js"></script>
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <div class="ajeitar">
                  ...
                  <h1 class="empresa-form">Minha Empresa</h1>
                  <br>

                  <form class="empresa-form" action="../server/controller/registrarEmpresa.php" method="post" enctype="multipart/form-data">
                    <div class="inputbox">
                    ...
                    <div class="inputbox">
                      <input type="text" class="registro" id="localEmpresa" name="cepEmpresa" maxlength="9" onblur="buscarEndereco(this)" oninput="mascaraCEP(this)" required></input>
                      <span>CEP da Sede</span>
                    </div>

                    <div class="form-group">
                      <div class="inputbox logradouro">
                        <input type="text" class="registro logradouro" id="cidadeEmpresa" name="cidadeEmpresa" required></input>
                        <span>Cidade</span>
                      </div>

                      <div class="inputbox numero">
                        <input type="text" class="registro numero" id="ufEmpresa" name="ufEmpresa" required></input>
                        <span>UF</span>
                      </div>
                    </div>

                    <div class="inputbox">
                      <input type="text" class="registro" id="bairroEmpresa" name="bairroEmpresa" required></input>
                      <span>Bairro</span>
                    </div>

                    <div class="form-group">
                      <div class="inputbox logradouro">
                        <input type="text" class="registro logradouro" id="logradouroEmpresa" name="logradouroEmpresa" required></input>
                        <span>Logradouro</span>
                      </div>

                      <div class="inputbox numero">
                        <input type="number" class="registro numero" id="numeroEmpresa" name="numeroEmpresa" required></input>
                        <span>Número</span>
                      </div>
                    </div>

                    <div class="inputbox">
                      <input type="text" class="registro" id="complementoEmpresa" name="complementoEmpresa"></input>
